...
and returns true if that number contains at least one zero. 
...
and returns true if there are no duplicate values (more than one element in the array that has the same value as another). 
